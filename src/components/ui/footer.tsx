        ...
        <FadeIn>
          <div className="flex flex-col items-center justify-center">
            ...
            <div className="flex space-x-6 mt-8">
              ...
              >
                <div className="w-10 h-10 flex items-center justify-center rounded-full bg-background backdrop-blur-sm border border-secondary/30 hover:bg-gradient-to-br from-accent/20 to-primary/20">
          ...
          <div className="border-t border-primary/10 mt-12 pt-6 flex flex-col md:flex-row justify-between items-center">
            ...
            <p className="text-primary/70 text-sm mt-2 md:mt-0">
              Powered by <a href="#" className="font-medium text-primary hover:text-accent transition-colors">Banyan Intelligence</a>
            </p>
          </div>
        </FadeIn>
      </div>
